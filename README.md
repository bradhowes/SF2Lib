...
SF2 files.
* [include](Sources/SF2Lib/include/SF2Lib) -- headers for the library. Note that the library exists mostly in header 
files with very little to be found in source files.
...
[Package.swift](Package.swift#L86) file, in the line `.define("PLAY_AUDIO", to: "1", .none)`. Change the "1" to "0" to 
