...
[Package.swift](Package.swift#L124) file, in the line `let playAudio = "0"`. Change the "0" to "1" to enable the audio
output for *all* tests. This will increase the test run time, but it can be helpful when making code changes.
