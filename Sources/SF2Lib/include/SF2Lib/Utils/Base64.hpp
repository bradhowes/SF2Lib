...
public:
  ...
  inline static const int decoder[256] = {
  ...
  inline static std::string decode(const std::string& input) noexcept {
  ...
  inline static std::string encode(const std::string& input) noexcept {
    auto inputSize = input.size();
