...
- (void)testKeyToMod {
  Float epsilon = 0.000001;
  auto s1 = contexts.context2.makeState(60, 32);
  ...
  auto s2 = contexts.context2.makeState(72, 32);
  ...
  auto s3 = contexts.context2.makeState(48, 32);
  ...
  auto s4 = contexts.context2.makeState(36, 32);
