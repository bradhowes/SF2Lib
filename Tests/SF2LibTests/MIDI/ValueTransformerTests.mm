...
- (void)testLinearAscendingUnipolar {
  ...
  XCTAssertEqualWithAccuracy(0.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.25, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.5, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.75, z(96), epsilon);
  XCTAssertEqualWithAccuracy(127.0 / 128.0, z(127), epsilon);
}

- (void)testLinearDescendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::linear, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::descending);
  XCTAssertEqualWithAccuracy(1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.75, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.5, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.25, z(96), epsilon);
  XCTAssertEqualWithAccuracy(1.0 - 127.0 / 128.0, z(127), epsilon);
}
...
- (void)testLinearAscendingBipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::linear, ValueTransformer::Polarity::bipolar,
                                ValueTransformer::Direction::ascending);
  XCTAssertEqualWithAccuracy(-1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(-0.5, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.5, z(96), epsilon);
  XCTAssertEqualWithAccuracy(127.0 / 128.0 * 2.0 - 1.0, z(127), epsilon);
}
...
- (void)testLinearDescendingBipolar {
  ...
  XCTAssertEqualWithAccuracy(-0.0, z(64), epsilon);
  XCTAssertEqualWithAccuracy(-0.5, z(96), epsilon);
  XCTAssertEqualWithAccuracy((1.0 - 127.0 / 128.0) * 2 - 1.0, z(127), epsilon);
}
...
- (void)testConcaveAscendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::concave, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::ascending);
  XCTAssertEqualWithAccuracy(0.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.052533381528, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.126859654793, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.255184177967, z(96), epsilon);
  XCTAssertEqualWithAccuracy(0.876584883732, z(126), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(127), epsilon);
}
...
- (void)testConcaveDescendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::concave, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::descending);
  XCTAssertEqualWithAccuracy(1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.249439059432, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.124009894572, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.0506385366318, z(96), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(127), epsilon);
}
...
- (void)testConcaveAscendingBipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::concave, ValueTransformer::Polarity::bipolar,
                                ValueTransformer::Direction::ascending);
  XCTAssertEqualWithAccuracy(-1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(-0.894933236944, z(32), epsilon);
  XCTAssertEqualWithAccuracy(-0.746280690415, z(64), epsilon);
  XCTAssertEqualWithAccuracy(-0.489631644065, z(96), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(127), epsilon);
}
...
- (void)testConcaveDescendingBipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::concave, ValueTransformer::Polarity::bipolar,
                                ValueTransformer::Direction::descending);
  XCTAssertEqualWithAccuracy(1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(-0.501121881137, z(32), epsilon);
  XCTAssertEqualWithAccuracy(-0.751980210857, z(64), epsilon);
  XCTAssertEqualWithAccuracy(-0.898722926736, z(96), epsilon);
  XCTAssertEqualWithAccuracy(-1.0, z(127), epsilon);
}
...
- (void)testConvexAscendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::convex, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::ascending);
  XCTAssertEqualWithAccuracy(0.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.750560940568, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.875990105428, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.949361463368, z(96), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(127), epsilon);
}
...
- (void)testConvexDescendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::convex, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::descending);
  XCTAssertEqualWithAccuracy(1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.947466618472, z(32), epsilon);
  XCTAssertEqualWithAccuracy(0.873140345207, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.744815822033, z(96), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(127), epsilon);
}
...
- (void)testSwitchedAscendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::switched, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::ascending);
  XCTAssertEqualWithAccuracy(0.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(63), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(64), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(127), epsilon);
}
...
- (void)testSwitchedDescendingUnipolar {
  auto z = makeValueTransformer(ValueTransformer::Kind::switched, ValueTransformer::Polarity::unipolar,
                                ValueTransformer::Direction::descending);
  XCTAssertEqualWithAccuracy(1.0, z(0), epsilon);
  XCTAssertEqualWithAccuracy(1.0, z(63), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(64), epsilon);
  XCTAssertEqualWithAccuracy(0.0, z(127), epsilon);
}
